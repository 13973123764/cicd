...
MySQL - 5.7.36-log : Database - nacos_config
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`nacos_config` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
(1,'baseservice.yml','DEFAULT_GROUP','storage:\n  minio:\n    endPoint: http://121.5.71.225:32376\n    bucketName: default\n    accessKey: mKB1bMr7YDwP9635\n    secretKey: CaSrfMge53UJjcd0ELiN4RFdNTR7PmyR\n  local:\n    path: /data\n    host: http://121.5.71.225:32376','6ee071146623e7ff96888f853e4ea812','2023-02-14 22:10:48','2023-02-14 22:34:24','nacos','10.0.4.13','','','','','','yaml',''),
(2,'gatewayservice.yml','DEFAULT_GROUP','gateway:\r\n    whites:\r\n        list:\r\n            - /auth/login   #登录\r\n            - /auth/logout  #登出\r\n            - /sys/v2/api-docs\r\n            - /ly/v2/api-docs\r\n            - /ly/mes/login # mes 登录\r\n            - /work/v2/api-docs\r\n','3431909102141bc3cdae2a8778f6d163','2023-03-15 11:12:12','2023-03-15 11:12:12','nacos','10.0.4.13','','',NULL,NULL,NULL,'yaml',NULL);
...
(0,6,'gatewayservice.yml','DEFAULT_GROUP','','gateway:\r\n    whites:\r\n        list:\r\n            - /auth/login   #登录\r\n            - /auth/logout  #登出\r\n            - /sys/v2/api-docs\r\n            - /ly/v2/api-docs\r\n            - /ly/mes/login # mes 登录\r\n            - /work/v2/api-docs\r\n','3431909102141bc3cdae2a8778f6d163','2023-03-15 11:12:12','2023-03-15 11:12:12','nacos','10.0.4.13','I','');
...
('nacos','$2a$10$/uh/nEDStiZEJIjxTJYqt.ZR5FNt0aFjqjDxvFBYMc6dSgIqOSchC',1);
